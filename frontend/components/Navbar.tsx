  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", gap: 4 }}>
        {links.map(l => (
          <Link key={l.href} href={l.href} style={{
            ...
            background: path === l.href ? "rgba(245,158,11,0.1)" : "transparent",
            border: path === l.href ? "1px solid rgba(245,158,11,0.3)" : "1px solid transparent",
      ...
      <div style={{ textAlign: "right" }}>
        <div style={{ fontSize: 12, fontWeight: 600, color: "var(--text-primary)" }}>Sr. Cmdt. R.K. Singh</div>
        <div style={{ fontSize: 10, color: "var(--amber)", fontFamily: "'IBM Plex Mono', monospace" }}>
          Procurement Cell · CRPF HQ
        </div>
      </div>
    </nav>
  );
